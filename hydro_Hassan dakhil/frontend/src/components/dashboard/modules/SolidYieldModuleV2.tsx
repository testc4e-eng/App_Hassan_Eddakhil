...
export function SolidYieldModuleV2() {
  ...
  useEffect(() => {
    ...
    const runIds = Array.from(
      new Set(
        availability
          .filter((row) => row.subbasin_station_id === subbasinStationId)
          .map((row) => row.run_id)
      )
    );
          ...
          <CardContent className="space-y-3">
            ...
            <div className="space-y-1">
              ...
              <Select
                ...
                onValueChange={(v) => setRunId(extractSelectNumericPart(v, 2))}
          ...
          <CardHeader className="pb-2">
            <div className="flex items-center justify-between gap-2">
              ...
              <ChartExportMenu
                ...
                pngDisabled={mode === "multi" ? !multiChartData.length : !series.length}
              />
            </div>
          </CardHeader>
          <CardContent>
