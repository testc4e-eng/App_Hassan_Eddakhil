...
def load_config(dry_run: bool) -> Config:
    return Config(
        ...
        pg_host=env_first("HDI_DB_HOST", "DB_HOST", default="localhost"),
        pg_port=int(env_first("HDI_DB_PORT", "DB_PORT", default="5432")),
        pg_db=env_first("HDI_DB_NAME", "DB_NAME", default="hydro_hd"),
        pg_user=env_first("HDI_DB_USER", "DB_USER", default="postgres"),
        pg_password=env_first("HDI_DB_PASSWORD", "DB_PASSWORD", default="postgres"),
        dry_run=dry_run,
    )
