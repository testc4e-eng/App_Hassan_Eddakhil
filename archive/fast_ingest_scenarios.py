...
PGHOST = env_first("HDI_DB_HOST", "DB_HOST", default="127.0.0.1")
PGPORT = env_first("HDI_DB_PORT", "DB_PORT", default="5436")
PGDATABASE = env_first("HDI_DB_NAME", "DB_NAME", default="hydro_hd")
PGUSER = env_first("HDI_DB_USER", "DB_USER", default="postgres")
PGPASSWORD = env_first("HDI_DB_PASSWORD", "DB_PASSWORD", default="local_test_password")
