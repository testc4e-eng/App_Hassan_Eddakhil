...
La collecte de `bdd_erosion_abhgzr_20-04-26` vers `hydro_hd_1714` est globalement cohérente sur les entités clés (communes, bassin, barrages, stations, bathymétrie) et les vues principales sont alimentées via `core.measurements`.
